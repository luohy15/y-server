...
// Helper functions
export function isBraveWebSearchArgs(args: unknown): args is { query: string; count?: number; offset?: number } {
  return (
    typeof args === "object" &&
    args !== null &&
    "query" in args &&
 ...
 */
export async function performWebSearch(query: string, count: number = 10, apiKey: string): Promise<string> {
